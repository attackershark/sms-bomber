...
def watermark():
    print("SMS Tool - Shark")

def get_number():
    global clear
    while True:
        try:
            number = int(input(f"""Telefon numarasını yazın. Şunun gibi: "54xxxxxxxx" (Sadece Türkiye numaralarında çalışır! Önerilen sms sayısı 25. Önerilen thread sayısı 5.)\n[?] : """))
